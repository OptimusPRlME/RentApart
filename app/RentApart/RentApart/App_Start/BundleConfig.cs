...
namespace RentApart
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new Bundle("~/bundles/lib")
            ...
            bundles.Add(new Bundle("~/bundles/select")
              .Include(ltecomponents + "select2/dist/js/select2.full.min.js"));     
            ...
            bundles.Add(new Bundle("~/bundles/bounce").Include(
                      "~/Scripts/bouncemarker.js"));

            bundles.Add(new Bundle("~/bundles/login").Include(
                      "~/Scripts/login.js"));

            bundles.Add(new Bundle("~/bundles/leaflet").Include(
                      "~/Scripts/leaflet-search.min.js"));

            bundles.Add(new Bundle("~/bundles/bounce").Include(
                      "~/Scripts/bouncemarker.js"));

            bundles.Add(new Bundle("~/bundles/geo").Include(
                      "~/Scripts/bootstrap-geocoder.js"));
